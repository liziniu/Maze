...
from her2.util import Acer, vf_dist
import sys
from baselines.common.tf_util import get_session
import os
from her2.buffer2 import ReplayBuffer
from her2.defaults import get_store_keys, THRESHOLD


def learn(network, env, seed=None, nsteps=20, total_timesteps=int(80e6), q_coef=0.5, ent_coef=0.01,
          max_grad_norm=10, lr=7e-4, lrschedule='linear', rprop_epsilon=1e-5, rprop_alpha=0.99, gamma=0.99,
          log_interval=1000, buffer_size=50000, replay_ratio=4, replay_start=10000, c=10.0, trust_region=True,
          alpha=0.99, delta=1, replay_k=4, env_eval=None, eval_interval=300,
          save_model=False, simple_store=True, goal_shape=(2,), nb_train_epoch=4, her=True, buffer2=True,
          save_interval=0, **network_kwargs):
